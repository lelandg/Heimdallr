...
EC2_HOST="${EC2_HOST:-ubuntu@your-instance-ip}"
SSH_KEY="$HOME/.ssh/chatmaster-key.pem"

if [[ "$EC2_HOST" == *"your-instance-ip"* ]]; then
    echo "Error: Please set EC2_HOST environment variable or edit this script"
    echo "Example: export EC2_HOST=ubuntu@198.51.100.1"
    exit 1
fi
