...
if [[ "$INSTANCE_ID" == *"0123456789"* ]]; then
    echo "Error: Please set MONITOR_INSTANCE_ID environment variable or edit this script"
    echo "Example: export MONITOR_INSTANCE_ID=i-0abc123def456789"
    exit 1
fi
